...
func (c *taskServiceClient) SubmitTask(ctx context.Context, in *Task, opts ...grpc.CallOption) (*TaskResponse, error) {
...
func (UnimplementedTaskServiceServer) SubmitTask(context.Context, *Task) (*TaskResponse, error) {
